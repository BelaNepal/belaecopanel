...
function getSprites({ hasFog = true, hue = 0.65, numSprites = 12, opacity = 0.28, path = '/textures/rad-grad.png', radius = 18, sat = 0.5, size = 48, z = -20 } = {}) {
...
export default function Nebula() {
  const sprites = getSprites({ numSprites: 12, radius: 18, z: -20, size: 48, opacity: 0.28, path: '/textures/rad-grad.png' });
